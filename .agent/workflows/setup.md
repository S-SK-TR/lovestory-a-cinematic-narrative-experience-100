...
- `CLAUDE.md` dosyasındaki `Lovestory: A Cinematic Narrative Experience`, `Lovestory: A Cinematic Narrative Experience — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
